          ...
          trigger:'hover'
              ...
              <div class="panel-group number">
                <div class="panel panel-info">
                  <div class="panel-heading text-uppercase"><span data-toggle="popover" data-placement="right" href="#" title="Aviso!" data-content="Valores financeiros sem considerar intervalo de tempo.">Números</span></div>
                  <div class="panel-body">
                    ...
                    <div class="col-md-3 col-sm-6  numero preto text-center text-uppercase" id="panel-num">
                      ...
                      <small title="" bt-xtitle="" class="bt-active bt-active">R$</small>
                      <span title="" bt-xtitle="" class="bt-active bt-active">0,00</span>
                    </div>

                ...
                <form action="edit.php?id=<?php echo $financial['id']; ?>" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6 col-md-4">
                      ...
                      value="<?php echo $financial['funcionario_responsavel']; ?>" disabled><!-- ARRUMAR DAVI - tem que aparecer o (Nome) do usuário logado no momento e enviar esse nome para o banco de dados (deixa disabled para evitar alteração)-->
                    </div>

        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navegacao" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
              ...
              <li id="oper" class="dropdown hidden-xs" data-html="true" data-placement="bottom" data-toggle="tooltip" href="#" data-original-title="<strong>Dúvidas</strong>">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <b class="fa fa-question-circle"> </b></a>
                <ul class="dropdown-menu">
                  <li class="dropdown-header text-center">Acesso a Informação</li>
                  <li><a href="#"><i class="fa fa-fw fa-commenting"></i> Atendimento via Chat</a></li>
                  <li><a href="#"><i class="fa fa-fw fa-envelope"></i> Atendimento via Email</a></li>
                  <li><a href="#"><i class="fa fa-fw fa-cog "></i> Configurar Usuário Suporte</a></li>
                  <li><a href="#"><i class="fa fa-fw fa-life-ring"></i> Página de Suporte</a></li>
                  <li><a href="#"><i class="fa fa-fw fa-user-circle-o"></i> Suporte Remoto</a></li>
                  <li><a href="#"><i class="fa fa-fw fa-cloud-download"></i> Downloads de Arquivos</a></li>
                  <li><a href="#"><i class="fa fa-fw fa-code"></i> Informações do Sistema</a></li>
                </ul>
              </li>
              ...
              <li class="dropdown" data-placement="bottom" data-html="true" data-toggle="tooltip" data-original-title=" <strong>Usuário</strong>">
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown-header text-center">Informações Usuário:<br> <?= $_SESSION['usuario']?> </li>
                  <li class="nav-divider"></li>
                  <li><a href=""><i class="fa fa-fw fa-user-secret"></i> Conta</a></li>
                  <li><a href=""><i class="fa fa-fw fa-credit-card"></i> Meu Plano</a></li>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                      ...
                      <ul id="submenu-2" class="collapse">
                        <li><a href="../buys/add.php"><i class="fa fa-fw fa-shopping-bag"></i>Nova Compra</a></li>
                        <li><a href="../buys/index.php"><i class="fa fa-fw fa-search"></i>Consultar Compras</a></li>
                      </ul>
                    </li>

             <?php
              ...
              <?php foreach ($sales as $sale) : ?>
                <tr>
                  <td><?php $d=KNome($sale['id']); echo $d[0]; ?></td>
                  <td><?php echo $sale['descricao_principal']; ?></td>
                  <td class="hidden-xs hidden-sm">
                  <?php
                  if ($sale['tipo_conta'] == 1) {
                    echo "<span class='label label-success'>Receber</span>";
                  }
                  if ($sale['tipo_conta'] == 2) {
                    echo "<span class='label label-danger'>Pagar</span>";
                  }
                  ?></td>
                  <td class="hidden-xs hidden-sm currency"><i class="fa fa-usd" aria-hidden="true"></i> <?php echo $sale['valor_total']; ?></td>
                  <td class="hidden-xs hidden-sm hidden-md"><?php echo date('d/m/Y', strtotime($sale['data_vencimento'])); ?></td>
